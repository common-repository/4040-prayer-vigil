 ...
 * @version $Id: 4040-options.php 1574454 2017-01-14 03:40:05Z danielsummers $
 */
...
<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<p>
			...
			<?php _e( "The ERLC is no longer producing the 40/40 Prayer Vigil. You can deactivate/uninstall this plugin.", 'fortyforty_plugin' ); ?>
		</p>
	</form>
	<p>
        <small>
